...
dependencies {
    ...
    implementation("androidx.appcompat:appcompat:1.11.0") // [Update 2025-06-06: von 1.7.1]
    implementation("com.google.android.material:material:1.12.0") // [Update 2025-06-06: von 1.11.0]

    implementation("androidx.room:room-runtime:2.8.0") // [Update 2025-06-06: von 2.7.1]
    implementation("androidx.room:room-ktx:2.8.0") // [Update 2025-06-06]
    kapt("androidx.room:room-compiler:2.8.0") // [Update 2025-06-06: von 2.7.1]
